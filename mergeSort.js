...
const mergeSort = (arr) => {
  if (!Array.isArray(arr)) {
    return `mergeSort error: "arr" parameter must be an Array found ${typeof arr}`;
  }
...
const testMergeSort = (mergeSort, ) => { 
  ...
  const testArr3Expected = `mergeSort error: "arr" parameter must be an Array found string`;
  ...
  const testArr6 = 899;
  const testArr6Expected = `mergeSort error: "arr" parameter must be an Array found number`;
  ...
  const testArr12Expected = `mergeSort error: "arr" parameter must be an Array found boolean`;
